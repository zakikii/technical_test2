                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="row">
                      ...
                      <input type="hidden", value={{$transaction->transaction->id}}, name="transaction_id", class = "form-control">
                      <input type="hidden", value={{$transaction->transaction->transaction_status}}, name="transaction_status", class = "form-control">
                      <input type="hidden", value={{$transaction->expired_time}}, name="expired_time" class = "form-control">
                      <div class="col-12 col-md-3">
                        ...
                        <select
                          ...
                          v-model="status"
                        >
                          <?php if($transaction->transaction->transaction_status == 'WAITING'){ ?>
                          <option value="WAITING">Waiting</option>
                          <option value="ONPROCCESS">On Proccess</option>
                          <?php } elseif($transaction->transaction->transaction_status == 'ONPROCCESS') { ?>
                          <option value="ONPROCCESS">On Proccess</option>
                          <option value="SHIPPING">Shipping</option> 
                          <?php } elseif($transaction->transaction->transaction_status == 'SHIPPING') { ?>
                          <option value="SHIPPING">Shipping</option> 
